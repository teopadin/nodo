...
# 2. Refinamiento Tipográfico y Visual (CSS)
st.markdown("""
    <style>
    ...
    .card {
        padding: 2.2rem;
        border-radius: 4px; /* Bordes más rectos para mayor sobriedad */
    ...
    /* Títulos de artículos con peso visual */
    ...
    /* Párrafos legibles */
    .stMarkdown p { font-size: 1.05rem; color: #333 !important; line-height: 1.7; font-family: 'Inter', sans-serif; }
    
    a { color: #0066cc !important; text-decoration: none; font-weight: 600; font-size: 0.9rem; border-bottom: 1px solid transparent; transition: border 0.3s; }
    a:hover { border-bottom: 1px solid #0066cc; }
    
    .stButton>button { border-radius: 0; border: 1px solid #000; background: white; color: #000; font-family: 'Inter', sans-serif; font-weight: 600; text-transform: uppercase; font-size: 0.7rem; letter-spacing: 0.1em; }
    </style>
